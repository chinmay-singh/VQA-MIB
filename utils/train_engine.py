    ...
    for epoch in range(start_epoch, __C.MAX_EPOCH):
        ...
        for step, (batch_dict) in enumerate(dataloader):
            ...
            for accu_step in range(__C.GRAD_ACCU_STEPS):
                ...
                loss_item = [pred['proj_feat'], sub_ans_iter]
        ...
        # log epoch loss on wandb
        loss_sum_dict = {}
        loss_sum_dict[__C.LOSS_FUNC] = loss_sum / data_size
        # Now being called in test_engine
        # log_losses(loss_sum_dict, mode=__C.RUN_MODE, epoch=epoch)
        ...
        # Evaluation for the train dataset
        test_engine(
            __C,
            dataset,
            state_dict=net.state_dict(),
