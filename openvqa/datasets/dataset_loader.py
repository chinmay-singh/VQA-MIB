...
class EvalLoader:
    ...
    def eval(self, __arg1, __arg2, __arg3, __arg4, __arg5, __arg6, __arg7, __arg8, **kwargs):
        return self.eval_moudle.eval(self.__C, __arg1, __arg2, __arg3, __arg4, __arg5, __arg6, __arg7, __arg8, **kwargs)
